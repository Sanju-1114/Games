...
var selectionTitle = document.querySelector(".selection");
...
function scoreCalculation(random, userPick, computerPick) {
  ...
  if (userScore === 5 || machineScore === 5) {
    playButtons.forEach((button) => button.classList.add("hide"));
...
restartButton.addEventListener("click", function (e) {
  userScore = 0;
  machineScore = 0;
  playButtons.forEach((button) => button.classList.remove("hide"));
